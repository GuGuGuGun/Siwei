...
import { NodeOperationState } from '../document/documentStore'
...
interface MindMapContextMenuProps {
  ...
  onAction: (action: MindMapMenuAction) => void
}

const actionIcons: Record<MindMapMenuAction, React.ReactNode> = {
...
export const MindMapContextMenu: React.FC<MindMapContextMenuProps> = ({
  ...
  const items: Array<{ action: MindMapMenuAction; label: string; disabled: boolean; danger?: boolean }> = [
