...
Siwei 基于 Tauri 2、React、TypeScript 和 Rust 构建。它把文档保存为可读、可备份、可版本管理的 `.siwei.json` 文件，同时提供思维导图视图、文档库检索、Markdown/JSON 导入导出，以及受控的内嵌 Siwei Agent 文档助手能力。
...
- 思维导图：基于 React Flow 与 Dagre 将大纲树自动布局为可视化导图，支持分支聚焦、导图内搜索和 PNG/PDF 导出。
